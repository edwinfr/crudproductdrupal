...
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required") : (""))];
    ...
    {
        return new Source("", "core/modules/system/templates/form-element-label.html.twig", "/opt/lampp/htdocs/drupal10/core/modules/system/templates/form-element-label.html.twig");
    }
